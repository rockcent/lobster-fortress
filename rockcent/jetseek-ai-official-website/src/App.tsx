        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
              <a href="#features" onClick={(e) => handleNavClick(e, '#features')} className="hover:text-white transition-colors cursor-pointer">核心功能</a>
              <a href="#audience" onClick={(e) => handleNavClick(e, '#audience')} className="hover:text-white transition-colors cursor-pointer">适用人群</a>
              <a href="#solution" onClick={(e) => handleNavClick(e, '#solution')} className="hover:text-white transition-colors cursor-pointer">解决方案</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              ...
              <a href="#solution" onClick={(e) => handleNavClick(e, '#solution')} className="px-8 py-4 rounded-full border border-white/20 text-white font-semibold text-lg hover:bg-white/5 transition-all cursor-pointer">
                了解解决方案
              </a>
            </div>
      ...
      <section aria-labelledby="comparison-heading" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-x-auto relative">
            <div className="md:hidden absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-[#05050a] to-transparent pointer-events-none z-10" />
            <p className="md:hidden text-xs text-gray-500 mb-2 pl-2">← 左右滑动查看更多 →</p>
